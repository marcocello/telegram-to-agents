...
- Inspecting an archive could miss broken imports caused by excluded compatibility modules, so the proof installs and starts the wheel outside the checkout.
